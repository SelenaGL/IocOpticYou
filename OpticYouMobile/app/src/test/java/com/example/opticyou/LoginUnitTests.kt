...
//        // Login amb un username que no conté "@"
//        val response = ServerRequests.login("192.168.1.100", 8083, "admin", "1234")
...
//        val response = ServerRequests.login("198.168.1.100", 8083, "admin@optica.cat", "1234")
//        assertNotNull("La resposta no pot ser null", response)
...
//        val response = ServerRequests.login("198.168.1.100", 8083, "usuari@optica.cat", "1234")
//        assertNotNull("La resposta no pot ser null", response)
//        assertEquals(true, response!!.success)
...
//        val response = ServerRequests.login("192.168.1.100", 8083, "admin@optica.cat", "error")
//        assertNotNull("La resposta no pot ser null", response)
